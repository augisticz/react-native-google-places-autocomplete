...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _renderRowData = (rowData) => {
    ...
    return (
      <Text style={[{flex: 1}, this.props.suppressDefaultStyles ? {} : defaultStyles.description, this.props.customStyles.description, rowData.isPredefinedPlace ? this.props.customStyles.predefinedPlacesDescription : {}]}
  ...
  _renderLoader = (rowData) => {
    if (rowData.isLoading === true) {
      return (
        <View style={[this.props.suppressDefaultStyles ? {} : defaultStyles.loader, this.props.customStyles.loader]}>
          {this._getRowLoader()}
        </View>
      );
    }
  ...
  _renderRow = (rowData = {}, sectionID, rowID) => {
    return (
      <ScrollView
        ...
        >
          <View style={[this.props.suppressDefaultStyles ? {} : defaultStyles.row, this.props.customStyles.row, rowData.isPredefinedPlace ? this.props.customStyles.specialItemRow : {}]}>
  ...
  _renderSeparator = (sectionID, rowID) => {
    ...
    return (
      <View
        key={ `${sectionID}-${rowID}` }
        style={[this.props.suppressDefaultStyles ? {} : defaultStyles.separator, this.props.customStyles.separator]} />
    );
  }
  ...
  _renderPoweredLogo = () => {
    ...
    return (
      <View
        style={[this.props.suppressDefaultStyles ? {} : defaultStyles.row, defaultStyles.poweredContainer, this.props.customStyles.poweredContainer]}
      >
        <Image
          style={[this.props.suppressDefaultStyles ? {} : defaultStyles.powered, this.props.customStyles.powered]}
          resizeMode='contain'
  ...
  _getFlatList = () => {
    ...
    if ((this.state.text !== '' || this.props.predefinedPlaces.length || this.props.currentLocation === true) && this.state.listViewDisplayed === true) {
      return (
        <FlatList
          style={[this.props.suppressDefaultStyles ? {} : defaultStyles.listView, this.props.customStyles.listView]}
  ...
  render() {
    ...
    return (
      <View
        style={[this.props.suppressDefaultStyles ? {} : defaultStyles.container, this.props.customStyles.container]}
        pointerEvents="box-none"
      >
        {!this.props.textInputHide &&
          <View
            style={[this.props.suppressDefaultStyles ? {} : defaultStyles.textInputContainer, this.props.customStyles.textInputContainer]}
          >
            ...
            style={[this.props.suppressDefaultStyles ? {} : defaultStyles.textInput, this.props.customStyles.textInput]}
